...
function registerReleasePostType()
{
    $labels = [
        'name'                  => _x('Releases', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Release', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Releases', 'flynt'),
        'name_admin_bar'        => __('Release', 'flynt'),
    ...
    $args = [
        'label'                 => __('Release', 'flynt'),
        'description'           => __('Release Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerReleasePostType');
