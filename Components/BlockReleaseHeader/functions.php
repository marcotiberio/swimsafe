...
namespace Flynt\Components\BlockReleaseHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockReleaseHeader', function ($data) {
    $data['dateFormat'] = get_option('date_format');
    return $data;
});

Options::addTranslatable('BlockReleaseHeader', [
    [
